...
exports.getAgeStatus = function (birthDate, targetDate) {
  ...
  switch (true) {
    case statusObj.year < 2:
      return "Infant";
    case statusObj.year < 5:
      return "Toddler";
    case statusObj.year < 13:
      return "Child";
    case statusObj.year < 20:
      return "Teen";
    case statusObj.year < 40:
      return "Adult";
    case statusObj.year < 60:
...
function calculateFullAge (bD, targetDate) {
  ...
  return { year: yearAge, month: monthAge, day: dateAge };
}
